...
namespace CareConnect.Infrastructure.Migrations
{
    ...
    [Migration("20260728144604_AddAccountSettingsAndProfileImages")]
    partial class AddAccountSettingsAndProfileImages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareConnect.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RecipientApplicationUserId")
                        .IsRequired()
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("RecipientApplicationUserId", "CreatedAt");

                    b.HasIndex("RecipientApplicationUserId", "IsRead");
            ...
            modelBuilder.Entity("CareConnect.Domain.Entities.Notification", b =>
                {
                    b.HasOne("CareConnect.Domain.Entities.ApplicationUser", "RecipientApplicationUser")
                        .WithMany("Notifications")
                        .HasForeignKey("RecipientApplicationUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("RecipientApplicationUser");
                });
